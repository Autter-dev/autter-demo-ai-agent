---
name: "Memory leaks private user data"
about: "Autter Sandbox challenge"
title: "Memory leaks private user data"
labels: ["autter-sandbox", "privacy"]
---

# Challenge: Memory leaks private user data
...
## Problem
Memory retrieval can return another user's stored context.
...
Fix the issue where memory retrieval can return another user's stored context.
