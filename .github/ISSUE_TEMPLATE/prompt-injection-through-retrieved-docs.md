---
name: "Prompt injection through retrieved docs"
about: "Autter Sandbox challenge"
title: "Prompt injection through retrieved docs"
labels: ["autter-sandbox", "ai safety"]
---

# Challenge: Prompt injection through retrieved docs
...
## Problem
Retrieved document content can override agent behavior.
...
Fix the issue where retrieved document content can override agent behavior.
...
* prompt injection and unsafe context handling
